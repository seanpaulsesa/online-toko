$('#example').czmChatSupport({
    ...
    popup: {
        ...
        header: {
            backgroundColor: "#10c379", /* Html color code */
            title: "Klik salah satu Team Toko - Kami", /* Writing is required */
            description: "Untuk tanya tanya Klik salah satu Team Toko - Kami" /* To remove, (description:false) */
        },
        ...
        persons: [
            ...
            {
                avatar: {
                    src: '<img src="assets/img/team/paul.jpeg" alt="Pace Koding">', /* Image, Icon or SVG */
                    backgroundColor: "#10c379", /* Html color code */
                    onlineCircle: true /* Avatar online circle. To remove, (onlineCircle:false) */
                },
                text: {
                    title: "Pace Koding", /* Writing is required */
                    description: "Team Toko - Kami", /* To remove, (description:false) */
            ...
            {
                avatar: {
                    src: '<img src="assets/img/team/paul.jpeg" alt="Pace Koding">', /* Font, Image or SVG */
                    backgroundColor: "#10c379", /* Html color code */
                    onlineCircle: true /* Avatar online circle. To remove, (onlineCircle:false) */
                },
                text: {
                    title: "Pace Koding", /* Writing is required */
                    description: "Team Toko - Kami", /* Custom text or false. To remove, (description:false) */
                ...
                link: {
                    desktop: "https://web.whatsapp.com/send?phone=+62082397029796&text=Hi, Pace Koding!", /* Writing is required */
                    mobile: "https://wa.me/+62082397029796/?text=Hi, Pace Koding!" /* If it is hidden desktop link will be valid. To remove, (mobile:false) */
                },
                onlineDay: {
                    /* Change the day you are offline like this. (sunday:false) */
                    sunday: "09:00-20:59",
